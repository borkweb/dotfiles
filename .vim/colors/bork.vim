...
if has("gui_running")
	...
	" -> Cursor
	hi Cursor         guibg=#FFEE68 guifg=black gui=none
	hi CursorIM       guibg=#FFEE68 guifg=black gui=none
	...
	hi MatchParen     guibg=#FFA500 guifg=#90CBF1 gui=none cterm=none ctermbg=green ctermfg=blue
...
elseif &t_Co == 256
	...
	hi MatchParen     ctermbg=blue  ctermfg=red   cterm=none
